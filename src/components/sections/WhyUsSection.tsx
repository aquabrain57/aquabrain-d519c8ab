        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <ul className="space-y-3 sm:space-y-4">
              {reasons.map((reason, index) => (
                ...
                >
                  <CheckCircle2 className="h-5 w-5 sm:h-6 sm:w-6 text-gold flex-shrink-0 mt-0.5" />
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-3 sm:-bottom-6 -left-2 sm:-left-6 bg-card p-3 sm:p-6 rounded-lg sm:rounded-xl shadow-lg sm:shadow-xl border border-border"
            >
              <div className="text-center">
                <span className="block text-2xl sm:text-4xl font-bold text-ocean">
                  100%
                </span>
            ...
            <motion.div
              ...
              className="absolute -top-3 sm:-top-6 -right-2 sm:-right-6 bg-gold p-3 sm:p-6 rounded-lg sm:rounded-xl shadow-lg sm:shadow-xl"
            >
              <div className="text-center">
                <span className="block text-2xl sm:text-4xl font-bold text-foreground">
                  8+
                </span>
